 ...
 * 7200 = 2 ชั่วโมง = '2h' ใน jsonwebtoken
 *
 ...
 */
export const SESSION_DURATION_SECONDS = 7200; // 2 ชั่วโมง
...
const _checks = [
    ...
    // SESSION_DURATION_SECONDS ต้องตรงกับ '2h' = 7200 (sanity check ป้องกัน typo)
    [SESSION_DURATION_SECONDS === 7200, 'SESSION_DURATION_SECONDS must equal 7200 (2h) to match JWT expiresIn'],
];
