...
const _checks = [
    ...
    // SESSION_DURATION_SECONDS sanity check: ป้องกัน typo ที่ค่าคลาดเคลื่อนจาก 8h
    // หมายเหตุ: check นี้ตรวจเฉพาะค่าตัวเลข ไม่ได้ enforce ว่า JWT expiresIn ตรงกันจริง
    // → ยังต้องตรวจด้วยตาว่า auth.js และ verify-mfa.js ใช้ SESSION_DURATION_SECONDS import จากที่นี่
    //   (ไม่ hardcode ค่า expiresIn แยกเอง)
    [SESSION_DURATION_SECONDS === 28800, 'SESSION_DURATION_SECONDS must equal 28800 (8h) — edit this check if intentionally changing session length'],
];
